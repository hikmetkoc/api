...
@EntityMetadataAnn(
    apiName = "customactivities", displayField = "instanceName", sortBy = "id", sortOrder = SortOrder.DESC,
    title = "Aktivite", pluralTitle = "Aktiviteler",
    ownerPath = "owner.id"
)
@Table(indexes = {@Index(columnList = "search")})
public class CustomActivity extends IdNameAuditingEntity<UUID> {
    ...
    private User owner;
    @FieldMetadataAnn(title = "Aktivite Başlığı", display = true, priority = 15, filterable = true)
    @Column(length = 2048)
