...
@EntityMetadataAnn(apiName = "proj_officers", displayField = "instanceName", title = "Sorumlu", pluralTitle = "Sorumlular",
    ownerPath = "owner.id")
@Table(indexes = {@Index(columnList = "search")})
public class ProjOfficer extends IdNameAuditingEntity<UUID> {
    ...
    @ManyToOne
    @FieldMetadataAnn(title = "Yetkisi", defaultValue = "ProjOfficer_Auth_Officer", display = true, filterable = true)
    @AttributeValueValidate(attributeId = "ProjOfficer_Auth")
    ...
    @ManyToOne
    @FieldMetadataAnn(title = "Bağlı Olduğu Proje", display = true, filterable = true)
    @JsonIgnoreProperties({"groups", "members", "createdBy", "lastModifiedBy", "roles"})
