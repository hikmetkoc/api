package tr.com.meteor.crm.web.rest;
...
import tr.com.meteor.crm.service.dto.PasswordChangeDTO;
import tr.com.meteor.crm.service.dto.UserDTO;
import tr.com.meteor.crm.service.mapper.UserMapper;
import tr.com.meteor.crm.utils.jasper.rest.AccountResource;
import tr.com.meteor.crm.utils.jasper.rest.errors.ExceptionTranslator;
import tr.com.meteor.crm.utils.jasper.rest.vm.KeyAndPasswordVM;
import tr.com.meteor.crm.utils.jasper.rest.vm.ManagedUserVM;
...
public class AccountResourceIT {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        Role role = new Role();
        role.setId(RolesConstants.ADMIN);
        ...
        when(mockUserService.getUserWithRoles()).thenReturn(Optional.of(user));
    ...
    public void testGetUnknownAccount() throws Exception {
        when(mockUserService.getUserWithRoles()).thenReturn(Optional.empty());
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setRoles(Collections.singleton(new Role().id(RolesConstants.USER)));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setRoles(Collections.singleton((new Role().id(RolesConstants.USER))));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setRoles(Collections.singleton(new Role().id(RolesConstants.USER)));
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        userService.updateUser(userMapper.toDto(testUser4.get()));
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        validUser.setImageUrl("http://placehold.it/50x50");
        validUser.setLangKey(Constants.DEFAULT_LANGUAGE);
        validUser.setRoles(Collections.singleton(new Role().id(RolesConstants.ADMIN)));
        ...
        assertThat(userDup.get().getRoles()).hasSize(1)
            .containsExactly(roleRepository.findById(RolesConstants.USER).get());
    }
    ...
    public void testSaveAccount() throws Exception {
        ...
        userDTO.setRoles(Collections.singleton(new Role().id(RolesConstants.ADMIN)));
